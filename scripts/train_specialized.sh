...
torchrun $DISTRIBUTED_ARGS pretrain/run_clm.py \
    ...
    --train_file /data/s1/chanwoo/nlp_project/parquet/specialized_train.parquet \
    --validation_file /data/s1/chanwoo/nlp_project/parquet/specialized_eval.parquet \
    --token False \
    --do_train \
    --do_eval \
    ...
    --output_dir /data/s1/chanwoo/nlp_project/logs/specialized \
    --ddp_timeout 18000 \
