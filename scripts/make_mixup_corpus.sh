...
python corpus_construction/sample_corpus.py \
    ...
    --ratio 0.25
python corpus_construction/sample_corpus.py \
    --src corpus_construction/nlp_project/experiment_corpus/specialized.json \
...
cat corpus_construction/nlp_project/experiment_corpus/specialized_for_mixup.json >> corpus_construction/nlp_project/experiment_corpus/mixup_corpus.json
...
python corpus_construction/shuffle_corpus.py \
    --src corpus_construction/nlp_project/experiment_corpus/mixup_corpus.json \
    --tgt corpus_construction/nlp_project/experiment_corpus/mixup_corpus_shuffled.json
...
rm corpus_construction/nlp_project/experiment_corpus/mixup_corpus.json